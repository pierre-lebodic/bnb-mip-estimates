...
parser.add_argument("--confidence_level",type=float,default=0.90,help="How strong should the confidence level of the confidence interval be? Values between 0 and 1")
parser.add_argument("--confidence_noplot",help="Should the confidence interval be hidden in the plot?",action="store_true")
parser.add_argument("--stds_not_weighted",help="Should the confidence interval be weighted by progress of tree exploration?",action="store_true")
